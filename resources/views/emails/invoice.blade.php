			...
			<table class="padding text-left small border-bottom">
				...
				<tbody class="strong">
					...
					<tr class="">
						...
						<td class="gry-color currency">{{ single_price($orderDetail->price/$orderDetail->quantity) }}
						</td>
		...
		<div style="padding:0 1.5rem;">
			<table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
				<tbody>
					...
					<tr class="border-bottom">
						<th class="gry-color text-left">{{ translate('15% Customs and Clearance Fees') }}</th>
						<td class="currency">
