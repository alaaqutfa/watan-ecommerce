        ...
        <form class="" action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
            <div class="row gutters-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" data-live-search="true" name="colors[]"
                                        data-selected-text-format="count" id="colors" multiple disabled required>
                ...
                <div class="col-lg-4">
                    ...
                    <input type="hidden" name="tax_type[]" value="percent" checked="">
                    <input type="hidden" name="tax[]" value="20" checked="">
