...
@section('panel_content')
    ...
    <div class="row">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-right">
                            ...
                            <!--</svg>-->
                             ...
                             <img src="{{ static_asset('assets/img/TOTAL_PRODUCT.jpg') }}" style="width: 100px height: 100px" alt="alert">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--                <div class="col-auto text-right">-->
                            ...
                            <!--</svg>-->
        <!--                    <img src="{{ static_asset('assets/img/photo2.png') }}" style="width: 100px height: 100px" alt="alert">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-right">
                            ...
                            <!--    </g>-->
                            <!--</svg>-->
                            <img src="{{ static_asset('assets/img/TOTAL_ORDERS.jpg') }}" style="width: 100px height: 100px" alt="alert">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-right">
                            ...
                            <!--    </g>-->
                            <img src="{{ static_asset('assets/img/TOTAL_WITHDRAW.jpg') }}" class="h-100 w-100" alt="alert">
                            </svg>
                        </div>
                    </div>
                </div>
