            ...
            <div class="card-body pb-0">
                <table class="table-borderless table">
                    <tbody>
                        ...
                        <!-- 5% Tax -->
                        <tr>
                            <td class="w-50 fw-600">{{ translate('5% Tax') }}</td>
                            <td class="text-right">
                                <span class="text-italic">{{ single_price($order->orderDetails->sum('price') * 0.05)
                                    }}</span>
                            </td>
                        </tr>
...
<tr>
    <td class="w-50 fw-600">
        {{ translate('15% Customs and') }}<br>{{ translate('Clearance Fees') }}
    </td>
    <td class="text-right">
        <span class="text-italic">{{ single_price($order->orderDetails->sum('price') * 0.15) }}</span>
    </td>
</tr>
