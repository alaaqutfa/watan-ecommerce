        ...
        <div class="card invisible">
            <div class="card-body">
                <form method="post" action="{{ $send }}">
                    <textarea name="customParam_token">{{ $session }}</textarea>
                    ...
                    <input type="text" name="oid" value="{{ $combined_order_id }}" />
                    <input type="hidden" name="responseSuccessURL" value="{{ route('api.magnati.success') }}"/>
                    <input type="hidden" name="responseFailURL" value="{{ route('api.magnati.cancel') }}"/>
