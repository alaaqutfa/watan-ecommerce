        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-4 col-6 mb-4">
                <a href="{{ route('products.category', $category->slug) }}" class="text-reset d-block">
                    <div class="category-box bg-white rounded-0 border text-center p-3">
                        <!-- Category Image -->
                        <div class="category-image size-60px mx-auto mb-2">
                            <img src="{{ uploaded_asset($category->banner) }}" alt="" class="img-fluid">
                        </div>
                        <!-- Category Name -->
                        <span class="fs-14 fw-700 hov-text-primary d-block">
            ...
            <div>
                <div class="text-dark d-flex align-items-center mb-0">
                    <a href="{{ route('flash-deals') }}"
                        class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary mr-3">{{
                        translate('View All Flash Sale') }}</a>
                    <span class=" border-left border-soft-light border-width-2 pl-3">
                        <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                            class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary">{{
                            translate('View All Products from This Flash Sale') }}</a>
                    </span>
                </div>
            </div>
        </div>
                            ...
                            <a href="{{ $product_url }}" class="d-block py-md-3 overflow-hidden hov-scale-img"
                                ...
                                <div
                                    ...
                                    <span class="d-block text-primary fw-700">{{
                                        home_discounted_base_price($flash_deal_product->product) }}</span>
                                    ...
                                    <del class="d-block fw-400 text-secondary">{{
                                        home_base_price($flash_deal_product->product) }}</del>
                                    @endif
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="aiz-card-box p-2 has-transition bg-white">
                        <div class="row hov-scale-img">
                            ...
                            <div class="col">
                                ...
                                <span class="badge badge-inline badge-soft-danger fs-13 fw-700 p-3 text-danger"
