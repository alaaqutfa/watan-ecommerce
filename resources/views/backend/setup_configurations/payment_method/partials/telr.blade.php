<form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" name="TELR_STORE_ID" id="TELR_STORE_ID"
                value="{{ env('TELR_STORE_ID') }}" placeholder="{{ translate('Telr store key') }}" required />
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <label class="col-from-label"
                for="TELR_AUTHENTICATION_KEY">{{ translate('Telr Authentication Key') }}</label>
        </div>
        <div class="col-md-8">
            <input type="text" class="form-control" name="TELR_AUTHENTICATION_KEY" id="TELR_AUTHENTICATION_KEY"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8 d-flex justify-content-start align-items-center">
            ...
            <label class="aiz-switch aiz-switch-success mb-0 float-right">
                <input type="checkbox" onchange="updatePaymentSettings(this, 'TELR_MODE',0)"
                    @if (env('TELR_MODE')) checked @endif>
